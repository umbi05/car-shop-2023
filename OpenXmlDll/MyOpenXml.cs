...
{
    public class MyOpenXml
    {
        public static WordprocessingDocument CreaDocx(string fileName)
        {
        ...
        public static Paragraph CreateSimpleParagraph(string paragraphContent)
        {
        ...
        #region HELPER FUNCTIONS FOR IMAGE PROCESSING
