...
namespace CarShopConsole
{
    class Program
    {
        ...
        {
            v = new Auto("Audi", "A3", 2000, "EURO 6", true, new DateTime(2019, 10, 01), 27600, "Diesel", new List<string>(), 90, 5, "Nero", "CZ830AA", 47300, new Veicolo.DimensioniStruct(445, 270, 168), 8, false, false, false, 19, 5, "Integrale", "Business", true);
            veicoli.Add(v);
            v = new Auto("Alfa Romeo", "Giulia", 2143, "EURO 6", true, new DateTime(2018 / 05 / 29), 40500, "Diesel", new List<string>(), 179, 5, "Blu", "EA781PQ", 50200, new Veicolo.DimensioniStruct(455, 290, 158), 6, true, true, false, 20, 5, "Integrale", "Standard", true);
            veicoli.Add(v);
            v = new Auto("BMW", "Serie 3", 2200, "EURO 5", false, new DateTime(2007, 04, 01), 30000, "Benzina", new List<string>(), 100, 5, "Bianca", "MM846RT", 120000, new Veicolo.DimensioniStruct(500, 290, 150), 6, false, true, true, 50, 5, "posteriore", "business", false);
            veicoli.Add(v);
            ...
            veicoli.Add(v);
            v = new Moto("Kawasaki", "Ninja H2", 1000, "EURO 4", true, new DateTime(2019, 10, 01), 29700, "Benzina", new List<string>(), 170, 2, "Nero", "GX321AB", 47300, new Veicolo.DimensioniStruct(84, 30, 47), 6, "stradale", 4, "hypersport", Avviamento.Automatico, false, "pelle", true, false);
            veicoli.Add(v);
        ...
        static void ExportDocx()
        {
            ...
            Process.Start(DOCXOUTPUTPATH);
        }

        static void ExportXlsx()
        {
            string finalPath = Utils.CreateXlsx(veicoli, XLSXOUTPUTPATH);
